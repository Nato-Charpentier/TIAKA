  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {activeSection === 'financier' && (
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-800 mb-3">Tableau de trésorerie Année 1 (exemple)</h3>
                <div className="overflow-x-auto">
                  <table className="w-full text-xs">
                    ...
                    <tbody className="divide-y text-sm">
                      {[
                        { mois: 'M1', enc: 1350000, dec: 1200000, solde: 150000, cumul: 1150000 },
                        { mois: 'M2', enc: 1350000, dec: 1190000, solde: 160000, cumul: 1310000 },
                        { mois: 'M3', enc: 1350000, dec: 1180000, solde: 170000, cumul: 1480000 },
                      ].map((row, idx) => (
                        <tr key={idx} className={idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'}>
                          <td className="p-2 font-medium">{row.mois}</td>
                          <td className="p-2 text-right text-green-600">{row.enc.toLocaleString()}</td>
                          <td className="p-2 text-right text-red-600">{row.dec.toLocaleString()}</td>
                          <td className="p-2 text-right font-medium">{row.solde.toLocaleString()}</td>
                          <td className="p-2 text-right font-bold text-blue-600">{row.cumul.toLocaleString()}</td>
                        </tr>
                      ))}
        ...
        {/* Section annexes et documents complémentaires */}
        <div className="bg-white rounded-2xl shadow-xl p-8 mt-6">
          <h2 className="text-3xl font-bold text-slate-800 border-b-2 border-red-500 pb-3 mb-6">
            ANNEXES & DOCUMENTS COMPLÉMENTAIRES
          </h2>

          <div className="space-y-6">
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl">
              <h3 className="text-xl font-bold text-slate-800 mb-4">📊 Tableaux financiers détaillés</h3>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-white p-4 rounded-lg border-2 border-blue-200">
                  <p className="font-bold text-blue-800 mb-2">Fichier 1 : Compte de résultat 5 ans</p>
                  <ul className="text-sm text-slate-700 space-y-1">
                    <li>• Onglet 1 : Vue annuelle synthétique</li>
                    <li>• Onglet 2 : Détail mensuel année 1</li>
                    <li>• Onglet 3 : Évolution indicateurs clés</li>
                  </ul>
                </div>
                <div className="bg-white p-4 rounded-lg border-2 border-green-200">
                  <p className="font-bold text-green-800 mb-2">Fichier 2 : Plan de financement</p>
                  <ul className="text-sm text-slate-700 space-y-1">
                    <li>• Onglet 1 : Besoins détaillés</li>
                    <li>• Onglet 2 : Ressources et échéancier</li>
                    <li>• Onglet 3 : Simulation remboursement</li>
                  </ul>
                </div>
                <div className="bg-white p-4 rounded-lg border-2 border-orange-200">
                  <p className="font-bold text-orange-800 mb-2">Fichier 3 : Tableau de trésorerie</p>
                  <ul className="text-sm text-slate-700 space-y-1">
                    <li>• Projection mois par mois année 1</li>
                    <li>• Encaissements / Décaissements</li>
                    <li>• Solde cumulé et alertes</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-xl">
              <h3 className="text-xl font-bold text-slate-800 mb-4">🏢 Données techniques local</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <p className="font-bold text-slate-800 mb-3">Caractéristiques recherchées</p>
                  <table className="w-full text-sm">
                    <tbody className="divide-y">
                      <tr>
                        <td className="py-2 font-medium">Surface</td>
                        <td className="py-2 text-right">100 m² utiles</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-medium">Emplacement</td>
                        <td className="py-2 text-right">Papeete centre, rue passante</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-medium">Visibilité</td>
                        <td className="py-2 text-right">Façade vitrée, enseigne possible</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-medium">Accessibilité</td>
                        <td className="py-2 text-right">Plain-pied, PMR</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-medium">Parking</td>
                        <td className="py-2 text-right">À proximité (public)</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-medium">Loyer cible</td>
                        <td className="py-2 text-right font-bold text-green-600">≤ 200 000 XPF/mois</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                <div>
                  <p className="font-bold text-slate-800 mb-3">Aménagements prévus</p>
                  <ul className="text-sm text-slate-700 space-y-2">
                    <li>• Climatisation renforcée (produits frais)</li>
                    <li>• Éclairage LED basse consommation</li>
                    <li>• Sol PVC alimentaire facile d'entretien</li>
                    <li>• Faux-plafond acoustique</li>
                    <li>• Réseau électrique adapté (frigos/congélateurs)</li>
                    <li>• Installation système de caisse moderne</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-xl">
              <h3 className="text-xl font-bold text-slate-800 mb-4">🎨 Logo TIAKA - Spécifications</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <p className="font-bold text-slate-800 mb-3">Concept visuel</p>
                  <ul className="text-sm text-slate-700 space-y-2">
                    <li>• Symbole central : Fleur de Tiare stylisée (5 pétales)</li>
                    <li>• Point rouge au centre (rappel drapeau japonais + cœur fleur)</li>
                    <li>• Typographie : Sans-serif moderne, épurée</li>
                    <li>• Couleurs primaires : Blanc (#FFFFFF), Bois naturel (#8B7355)</li>
                    <li>• Couleur accent : Rouge corail (#FF6B6B)</li>
                  </ul>
                </div>
                <div>
                  <p className="font-bold text-slate-800 mb-3">Déclinaisons & Applications</p>
                  <div className="space-y-3">
                    <div className="bg-white p-3 rounded">
                      <p className="font-medium text-sm">Versions</p>
                      <p className="text-xs text-slate-600 mt-1">• Complète (logo + texte)</p>
                      <p className="text-xs text-slate-600">• Picto seul (réseaux sociaux)</p>
                      <p className="text-xs text-slate-600">• Monochrome (documents N&B)</p>
                    </div>
                    <div className="bg-white p-3 rounded">
                      <p className="font-medium text-sm">Applications</p>
                      <p className="text-xs text-slate-600 mt-1">• Enseigne lumineuse extérieure</p>
                      <p className="text-xs text-slate-600">• Façade vitrée (vitrophanie)</p>
                      <p className="text-xs text-slate-600">• Sacs papier kraft</p>
                      <p className="text-xs text-slate-600">• Cartes de fidélité</p>
                      <p className="text-xs text-slate-600">• Uniformes (broderie)</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 p-6 rounded-xl">
              <h3 className="text-xl font-bold text-slate-800 mb-4">📞 Partenaires et contacts utiles</h3>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <div className="bg-white p-3 rounded-lg">
                    <p className="font-bold text-slate-800 text-sm mb-2">Administrations</p>
                    <div className="space-y-1 text-xs text-slate-700">
                      <p>• CCI Tahiti : 40 47 27 47 (accompagnement création)</p>
                      <p>• Service Commerce : autorisation exploitation</p>
                      <p>• Mairie Papeete : licence enseigne</p>
                      <p>• DICP : 40 46 13 13 (déclarations fiscales)</p>
                    </div>
                  </div>
                  
                  <div className="bg-white p-3 rounded-lg">
                    <p className="font-bold text-slate-800 text-sm mb-2">Organismes d'aide</p>
                    <div className="space-y-1 text-xs text-slate-700">
                      <p>• SEFI : 40 46 12 12 (microcrédit)</p>
                      <p>• ADT : labellisation possible</p>
                      <p>• Chambre des Métiers : accompagnement</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="bg-white p-3 rounded-lg">
                    <p className="font-bold text-slate-800 text-sm mb-2">Banques</p>
                    <div className="space-y-1 text-xs text-slate-700">
                      <p>• Banque de Tahiti : prêt professionnel</p>
                      <p>• Banque Socredo : offres créateurs</p>
                      <p>• OPT Vini : financement digital</p>
                    </div>
                  </div>
                  
                  <div className="bg-white p-3 rounded-lg">
                    <p className="font-bold text-slate-800 text-sm mb-2">Fournisseurs potentiels</p>
                    <div className="space-y-1 text-xs text-slate-700">
                      <p>• Produits locaux : Marché Papeete, coopératives</p>
                      <p>• Produits japonais : Importateurs Nouméa/Auckland</p>
                      <p>• Équipements : Fournisseurs CHR Tahiti</p>
                    </div>
                  </div>
                </div>
              </div>
